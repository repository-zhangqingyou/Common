...
import com.zqy.common.utils.TimeUtil;
...
public class ExceptionAppender extends UnsynchronizedAppenderBase<ILoggingEvent> {
    ...
    public void error(ILoggingEvent loggingEvent) {
        ...
        // TErrorLog数据表实体类
        com.zqy.common.model.Exception exception = new com.zqy.common.model.Exception();
    ...
    public interface ExceptionCallBack {
        void onException( com.zqy.common.model.Exception exception);
    }
}
